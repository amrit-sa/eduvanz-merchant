...
class InActiveProducts extends React.Component {
    ...
    handleChangePage = (event, value) => {
        let getProd = { merchant_id: this.props.user_id, page: value, limit: this.state.limit, status: "inactive" }
    ...
    handleChangelimitOfPage = (event) => {
        ...
        let getProd = { merchant_id: this.props.user_id, page: this.state.page, limit: perRowData, status: "inactive" }
    ...
    updateSellingPrice = (item) => {
        ...
        this.props.dispatch(merchentProductSellingPriceUpdate(getProd)).then((response) => {
            if (!response.responseCode) {
                let get_products = { merchant_id: this.props.user_id, status: "inactive", page: this.state.page, limit: this.state.limit }
    ...
    render() {
        ...
        console.log('in active prod', products)
        return (
            <>
                                        ...
                                        (
                                            products.proData.map((item, index) => (
                                                ...
                                                <div className="d-flex align-items-center justify-content-around">
                                                    ...
                                                    <button className='edit_btn' dataField='edit' >
                                                        <img src="images/icons/edit_20.png" alt="" className='img-fluid' />
                                                    </button>
                                                </div>
                                            </td> */}
                                                    ...
                                                    <td> <div className="switch_btn d-flex">
                                                        <label className="switch mr-3">
                                                            <input type="checkbox"
                                                                ...
                                                                //   defaultChecked={item.activate_product__c?  false:true} 
                                                                //defaultChecked={item.activate_product__c && item.activate_product__c === false ? true : false}
                                                                //defaultChecked={item.activate_product__c ? item.activate_product__c : false}
                                                                checked={item.activate_product__c === false ? false : true}
                                                        ...
                                                        {item.activate_product__c && item.activate_product__c !== false ? "Active" : "Inactive"}
